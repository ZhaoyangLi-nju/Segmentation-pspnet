...
train_transforms.append(
    segmentation_dataset.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225], ms_targets=ms_targets))

val_transforms = list()
# val_transforms.append(segmentation_dataset.Resize(cfg.LOAD_SIZE_cityscapes))
# val_transforms.append(segmentation_dataset.CenterCrop(cfg.FINE_SIZE_cityscapes))
val_transforms.append(segmentation_dataset.ToTensor())
val_transforms.append(segmentation_dataset.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]))
